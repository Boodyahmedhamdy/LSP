...
--
-- Host: 127.0.0.1:3388
-- Generation Time: Apr 27, 2023 at 12:40 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_rows_count` (IN `table_name` VARCHAR(50))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_table_rows_number` (IN `table_name` VARCHAR(50), OUT `row_count` INT)   BEGIN
...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `getUserById` () RETURNS INT(11)  BEGIN
    DECLARE count INT;
...
INSERT INTO `books` (`id`, `name`, `author_name`, `isbn`, `catigory_id`, `rack_number`, `image_url`, `is_borrowed`) VALUES
(127, 'data analysis dummies', 'slnvanvfmsalm.', 999999999, 1, 0, '1682113599030.png', 1),
(129, 'Another Up', 'rawan gamal', 999999999, 1, 0, '1682253753926.png', 1),
(130, 'Another Up', 'rawan gamal', 999999999, 1, 0, '', 1),
(131, 'defualt_book_name', 'defualt_author_name', 999999999, 12, 0, 'defualt_image_url', 1),
(132, 'welcome book\r\n', 'defualt_author_name', 999999999, 12, 0, 'defualt_image_url', 1),
(133, 'defualt_book_name', 'defualt_author_name', 0, 12, 0, 'defualt_image_url', 0);
...
(6, 140, 131, '2023-04-26 13:30:44', 2, 1),
(7, 139, 132, '2023-04-26 13:33:14', 2, 1);
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `phone`, `role_id`, `token`) VALUES
(133, 'shehabgamal;', 'shehabgamal@gmail.com', '$2b$10$D/GYqig5SFcsHoXdU0eNNOM7e3lRSa8Yi9OzSpC6ARdoPv.Z.4k7C', '01234567890', 1, '775df8297a72dafe3a9d9ebcfbc4ec21'),
(135, 'shehabgamal;', 'shehabgamal@gmail.com', '$2b$10$Rx1oiUqIfiyF3X0gmwJuPe42OS3rSEBjAuI3Mt3UOFZAOWkrl6NB6', '01234567890', 2, '38874843dc2082f05eb5f4fa3b96cadd'),
(137, 'boody', 'boody@Spring.com', '12345678', '01234567890', 1, 'randomGeneratedToken'),
(138, 'boody', 'boody@Spring.com', '12345678', '01234567890', 1, 'anotherRadomToken'),
(139, 'shehabgamal;', 'sensi@gmail.com', '$2b$10$gZoiOIKFU3.0KvLyaf8uweIiYlfS5D8S2grY2eJOimtwDnILefgba', '01234567890', 3, 'ee03d340bf8186a7f291454a11b38513'),
(140, 'defualt_user_name', 'defualt_user_email', '', '01234567890', 3, 'defualt_user_token');
